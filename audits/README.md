...
The v0.2.0-preflight audits are fail-closed tools:
...
| `r_law1_two_channel_origin_audit_v3_1.py` | records scalar single-channel obstruction and conditional two-channel mechanism | native channel provenance open |
| `r_law1_cross_protocol_cone_audit_v3_2.py` | tests cross-protocol unordered cone naturality under frozen maps | calibration only |
